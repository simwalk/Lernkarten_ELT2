...
%			simon.walker@hsr.ch
%	Lizenz: CC BY-NC-SA
%			Für bilder gelten andere Lizenzen dise sind jeweils als Kommentar hinter dem Include angegeben
...
\begin{document}
	...
	\fach{ELT2}
	\input{sections/ElektroStatik.tex}
	\input{sections/MagnetoStatik.tex}
